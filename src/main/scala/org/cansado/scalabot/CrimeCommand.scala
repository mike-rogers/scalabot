...
class CrimeCommand extends BaseCommand {
  ...
  val he_01 = Array( "a superhumanly strong","an underprivileged","a globe-trotting","an impetuous","a shy","a suave",
  ...
  val he_02 = Array( "white trash","zombie","shark-wrestling","playboy","guitar-strumming","Jewish",
  ...
  val he_03 = Array( "grifter","stage actor","paramedic","gentleman spy","jungle king","hairdresser",
  ...
  val he_04 = Array( "with a robot buddy named Sparky","whom everyone believes is mad","gone bad",
		    ...
		    "in drag","plagued by the memory of his family's brutal murder",
  ...
  val she_01 = Array( "a radical","a green-fingered","a tortured","a time-travelling","a vivacious",
  ...
  val she_02 = Array( "tempestuous", "Buddhist", "foul-mouthed", "nymphomaniac", "green-skinned", "impetuous", "African-American",
                     "punk","hypochondriac","junkie","blonde","goth","insomniac","gypsy","mutant","renegade", "tomboy",
                     "French-Canadian","motormouth","belly-dancing","communist","hip-hop","thirtysomething",
  ...
  val she_03 = Array ( "archaeologist","pearl diver","mechanic","detective","hooker","femme fatale",
  ...
  val she_04 = Array( "on her way to prison for a murder she didn't commit","trying to make a difference in a man's world",
                     ...
                     "from Mars","with someone else's memories","from a different time and place",
  ...
  def execute(): String = {
    ...
    ("He's " +
     he_01(random.nextInt(he_01.length)) + " " +
     he_02(random.nextInt(he_02.length)) + " " +
     he_03(random.nextInt(he_03.length)) + " " +
     he_04(random.nextInt(he_04.length)) + ". She's " +
     she_01(random.nextInt(she_01.length)) + " " +
     she_02(random.nextInt(she_02.length)) + " " +
     she_03(random.nextInt(she_03.length)) + " " +
     she_04(random.nextInt(she_04.length)) + ". They fight crime.")
  }
}
